# MathsForge Chapter 8 - Applications of Integrals

A separate, static Class 12 Mathematics learning website for **Chapter 8: Applications of Integrals**. It is frontend-only, so it can be shared publicly through GitHub Pages without paid hosting, paid APIs, databases, or subscriptions.

Public website:

```text
https://armaankapoor-ship-it.github.io/mathsforge-chapter-8/
```

GitHub repository:

```text
https://github.com/armaankapoor-ship-it/mathsforge-chapter-8
```

## What Is Included

- Topic notes for Applications of Integrals
- Formula sheet
...
2. Create a new public repository named `mathsforge-chapter-8`.
